...
[![Version](https://img.shields.io/badge/version-1.2.0-blue.svg)](https://github.com/Helchan/Marsunso.git)
...
| **新建文件夹** | 在文件夹树中选中父文件夹，点击“新建文件夹”按钮，输入名称后确认 |
